...
|---|---|---|
| Số dòng CSS | Nhiều hơn, khoảng 50-80 dòng | Ít hoặc không cần CSS riêng |
| Thời gian phát triển | Lâu hơn | Nhanh hơn |
| Responsive | Phải tự viết media query | Có sẵn grid và breakpoint |
| Tùy biến | Chủ động hơn | Nhanh nhưng dễ giống Bootstrap |

Nên dùng Bootstrap khi cần làm nhanh landing page, dashboard, form, modal, navbar responsive.

Không nên dùng Bootstrap khi giao diện cần thiết kế quá riêng hoặc muốn tự kiểm soát CSS chi tiết.
